  ...
  return (
    <div className="bg-gradient-to-br from-blue-200 to-blue-400 h-screen flex flex-col items-center justify-center relative">
      <div className="absolute top-5 right-5">
        <Link
          to="/"
          className="text-white font-semibold text-lg hover:underline flex items-center gap-2"
        >
          Back to home
          <svg
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`bg-blue-500 text-white rounded-lg px-4 py-2 w-full flex justify-center ${
